...
function Header({ navigation }) {
  ...
  return (
    <header
      className={clsx(
        'sticky top-0 z-50 flex flex-none flex-wrap items-center justify-between px-4 py-5 transition duration-500 dark:shadow-none sm:px-6 lg:px-8',
        isScrolled
          ? 'shadow-md shadow-slate-900/5 bg-white dark:bg-slate-900/95 dark:backdrop-blur dark:[@supports(backdrop-filter:blur(0))]:bg-slate-900/75'
          : 'dark:bg-transparent'
      )}
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" aria-label="Home page">
          ...
          <Logo className="hidden h-9 w-auto fill-slate-700 dark:fill-orange-100 lg:block" />
        </Link>
      </div>
      ...
      <div className="relative flex basis-0 justify-end gap-6 sm:gap-8 md:flex-grow">
        ...
        <Link href="https://github.com/shpyrd-io/shpyrd" className="group" aria-label="GitHub">
